...
// 프론트에서 정의한 큰 카테고리 및 하위 항목
const predefinedChecklist = [
    {
        category: "기본 계약 정보",
        status: true || false,
        items: [
            { title: "계약서 상 임대인 정보 확인", status: false, boundingBox: [] },
            { title: "계약서 상 임차인 정보 확인", status: false, boundingBox: [] },
            { title: "계약 기간 명시", status: false, boundingBox: [] },
            { title: "계약 대상(주택 주소, 면적) 명확하게 기재", status: false, boundingBox: [] },
        ]
    },
    {
        category: "보증금 및 월세 조건",
        status: true || false,
        items: [
            { title: "보증금 및 월세 명시 (금액 숫자 정확히 기입)", status: false, boundingBox: [] },
            { title: "월세 납부 방법 명시 (계좌이체/현급 납부 방식)", status: false, boundingBox: [] },
            { title: "연체 시 연체이자율 기재 (법정 최고이자율 초과 금지)", status: false, boundingBox: [] },
        ]
    },
    {
        category: "관리비 및 공과금 부담 명확화",
        status: true || false,
        items: [
            { title: "관리비 포함 항목 확인 (수도, 전기, 가스, 인터넷 등)", status: false, boundingBox: [] },
            { title: "개별 부담 항목(난방비, 주차비 등) 확인", status: false, boundingBox: [] },
        ]
    },
    {
        category: "시설 및 수리 책입 조항",
        status: true || false,
        items: [
            { title: "기본 시설물(도배, 장판, 가전 등) 유지·보수 책임 명확화", status: false, boundingBox: [] },
            { title: "계약 종료 시 원상복구 의무 여부 확인", status: false, boundingBox: [] },
        ]
    },
    {
        category: "전세 계약 시 추가 확인 사항",
        status: true || false,
        items: [
            { title: "전세보증보험 가입 가능 여부 확인", status: false, boundingBox: [] },
            { title: "보증금 반환 기한 및 방식 명시", status: false, boundingBox: [] },
        ]
    },
    {
        category: "반전세(준전세) 계약 시 추가 확인 사항",
        status: true || false,
        items: [
            { title: "보증금과 월세 비율 조정 가능 여부 확인", status: false, boundingBox: [] },
            { title: "보증금 반환 조건 및 월세 변동 가능성 기재", status: false, boundingBox: [] },
        ]
    },
    {
        category: "계약 해지 및 갱신 조건 명시",
        status: true || false,
        items: [
            { title: "중도 해지 시 위약금 여부", status: false, boundingBox: [] },
            { title: "계약 갱신 가능 여부 및 조건 명시", status: false, boundingBox: [] },
            { title: "임대인의 중도 해지 가능 여부 (매매 시 계약 승계 여부 포함)", status: false, boundingBox: [] },
        ]
    },
    {
        category: "특약 사항 명시 (계약서에 추가 기재)",
        status: true || false,
        items: [
            { title: "도배, 장판 등 집 원상복구 여부", status: false, boundingBox: [] },
            { title: "옵션 가구 및 가전제품 유지보수 책임자", status: false, boundingBox: [] },
            { title: "임대인의 방문 가능 여부 및 사전 통보 조건", status: false, boundingBox: [] },
            { title: "건물 매각 시 임차인 보호 조항 포함", status: false, boundingBox: [] },
        ]
    }
];
